# team-17 Platanus Hack 26: CDMX Project
...
- Humberto Alavez Hernandez ([@humbertoher17](https://github.com/humbertoher17))
- Emmitt Bryan Méndez Atlatenco ([@EmmittMendez](https://github.com/EmmittMendez))
- Edgar Cervantes Cruz ([@edcruztw](https://github.com/edcruztw))
- Ian Santiago Minor Nava ([@ianminor](https://github.com/ianminor))
...
2. Point your local `origin` at **both** repos, so a single `git push` updates each one:
   ...
   git remote set-url --add --push origin https://github.com/platanus-hack/platanus-hack-26-mx-team-17.git
